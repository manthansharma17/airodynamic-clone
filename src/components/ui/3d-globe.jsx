...
function Marker({
  ...
  const topPosition = useMemo(() => {
    return latLngToVector3(marker.lat, marker.lng, radius * 0.9);
  }, [marker.lat, marker.lng, radius]);
    ...
    <group ref={groupRef} visible={isVisible}>
      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <div
            className={cn(
              "flex h-2 w-2 cursor-pointer items-center justify-center rounded-full bg-[#0B2D63] shadow-lg transition-all duration-300",
              hovered && "scale-1 bg-blue-600",
            )}
